...
<html lang="en">
    <head>
        ...
        <title>QUIZZY - INSTALLATION</title>
                ...
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed QUIZZY</span>  
                                </div>
